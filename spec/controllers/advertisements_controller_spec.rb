...
RSpec.describe AdvertisementsController, type: :controller do
  ...
  describe "POST #create" do
    ...
    it "increases the number of advertisements by 1" do
      expect{post :create, advertisement: {title: Faker::Hipster.sentence, body: Faker::Hipster.paragraph, price: 100}}.to change(Advertisement,:count).by(1)
    end

    it "assigns the new advertisement to @advertisement" do
      post :create, advertisement: {title: Faker::Hipster.sentence, body: Faker::Hipster.paragraph, price: 100}
