...
RSpec.describe TopicsController, type: :controller do
  ...
  context "guest" do
    ...
    describe "GET index" do
      ...
      it "assigns all public topics to @topics" do
        get :index
        expect(assigns(:topics)).to eq(Topic.where(public: true))
      end
    ...
    describe "GET show" do
      ...
      it "redirects for private topics" do
    ...
    describe "POST create" do
      it "returns http redirect" do
        post :create, params: {topic: {name: Faker::Hipster.sentence, description: Faker::Hipster.paragraph}}
        expect(response).to redirect_to(new_session_path)
      end
    end
  ...
  context "admin user" do
    ...
    describe "POST create" do
      it "increases the number of topics by 1" do
        expect{ post :create, params: {topic: {name: Faker::Hipster.sentence, description: Faker::Hipster.paragraph} }}.to change(Topic,:count).by(1)
      end
