...
RSpec.describe QuestionsController, type: :controller do
  ...
  describe "POST create" do
    ...
    it "increases the number of questions by 1" do
      expect{post :create, question:{title: Faker::Hipster.sentence, body: Faker::Hipster.paragraph, resolved: rand(0..1)}}.to change(Question,:count).by 1
    end

    it "assigns the new question to @question" do
      post :create, question:{title: Faker::Hipster.sentence, body: Faker::Hipster.paragraph, resolved: rand(0..1)}
