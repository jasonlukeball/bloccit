...
RSpec.describe SponsoredPostsController, type: :controller do
  ...
  describe "POST create" do
    ...
    it "increases the number of sponsored posts by 1" do
      expect{post :create, topic_id: my_topic.id, sponsored_post: {title: Faker::Hipster.sentence, body: Faker::Hipster.paragraph, price: 100}}.to change(SponsoredPost, :count).by(1)
    end

    it "assigns the new sponsored_post to @sponsored_post" do
      post :create, topic_id: my_topic.id, sponsored_post: {title: Faker::Hipster.sentence, body: Faker::Hipster.paragraph, price: 100}
